...
## This is how you can use the Chatbot

1. First you must enter your name (just type it and press Enter)
2. Ask about any cybersecurity topic, type naturally or use the Quick Topic buttons
3. Make a follow up by just typing "tell me more" or "give me another tip" to get more on the same topic
